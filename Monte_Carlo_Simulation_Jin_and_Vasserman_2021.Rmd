...
gen_choice_probability <- function(df, theta, cost_par, R){
  # Parameters
  eta_f <- theta[1:4]
  xi <- theta[5:6]
  alpha_m0 <- theta[7:9]
...
tmp <- gen_lambda(df, cost_par, 50)
tmp3 <- gen_choice_probability(df, theta, cost_par, 50)

# tmp2 <- gen_choice_probability(df, theta, cost_par, 50)
